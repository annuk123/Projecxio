...
export default function ContactForm() {
  ...
  return (
    <main className="min-h-screen bg-grid-dark text-white flex items-center justify-center px-4 py-20">
      ...
      >
        <h1 className="text-4xl font-bold mt-6 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent  dark:text-gray-400">Contact.</h1>
      ...
      >
        {/* Name */}
        <div className="flex flex-col">
        <label className="mb-1 font-medium text-gray-700 dark:text-gray-300 text-left">Name</label>
        <input
  name="name"
  required
  placeholder="Your Name"
...
/>
        ...
        {/* Email */}
        <div className="flex flex-col">
        <label className="mb-1 font-medium text-gray-700 dark:text-gray-300 text-left">Email</label>
          <input
            name="email"
            type="email"
            required
